...
RSpec.describe AddressBook do
    ...
    describe "#import_from_csv2" do
        ...
        it "imports the 1st entry" do
            book.import_from_csv("entries_2.csv")
            entry_one = book.entries[0]
            check_entry(entry_one, "Billy", "619-555-4854", "billy@blocmail.com")
        end
        ...
        it "imports the 2nd entry" do
            ...
            # Check the second entry
            entry_two = book.entries[1]
            check_entry(entry_two, "Bobby", "619-555-5415", "bobby@blocmail.com")
        end
        ...
        it "imports the 3rd entry" do
            ...
            # Check the third entry
            entry_three = book.entries[2]
            check_entry(entry_three, "Joey", "619-555-3660", "joey@blocmail.com")
        end
    end

    describe "#iterative_search" do
        it "searches AddressBook for a non-existent entity" do
            book.import_from_csv("entries.csv")
